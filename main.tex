...
Also, privilege revocation is another important feature. The cryptographic accumulator \cite{accumulator} is an ideal method to realize revocation for many privacy-preserving authentication schemes, including anonymous credentials. 
