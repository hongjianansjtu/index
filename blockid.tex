...
Worth noting that, we tried our best to enhance the compared schemes to support lightweight nodes in our later evaluations. 
 ...
 1) authentication performance: picture to show the needed storage for targeted parameters. Then the efficiency comparison under the paramters.
...
As long as the consensus mechanism is safe, the above feature holds even in a insecure or instable communication environment. 
