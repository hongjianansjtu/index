...
The proposed scheme works in a communication system with the following 3 kines of entities: multiple CAs, lightweight nodes and a set of blockchain full nodes. Their relationship is shown as Fig. \ref{architecture}. 
