...
\end{figure}
\begin{itemize}
	\item The CAs play the similar role as those in traditional PKI systems, which are responsible for issuing and revoking certificates for other entities. In AcBF, 
\end{itemize}

multiple rCAs \cite{Gennaro2019FullyDG}
...
%while authorities are responsible for determining the privilege of each ID with off-chain credentials. 
